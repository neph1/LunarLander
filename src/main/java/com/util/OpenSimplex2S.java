...
public class OpenSimplex2S {
    ...
    /**
     * 2D OpenSimplex2S/SuperSimplex noise, with Y pointing down the main
     * diagonal. Might be better for a 2D sandbox style game, where Y is
     * vertical. Probably slightly less optimal for heightmaps or continent
     * maps, unless your map is centered around an equator. It's a slight
    ...
    /**
     * 3D OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X,
     * Y). Recommended for 3D terrain and time-varied animations. The Z
     * coordinate should always be the "different" coordinate in whatever your
     * use case is. If Y is vertical in world coordinates, call
     * noise3_ImproveXZ(x, z, Y) or use noise3_XZBeforeY. If Z is vertical in
     * world coordinates, call noise3_ImproveXZ(x, y, Z). For a time varied
     * animation, call noise3_ImproveXY(x, y, T).
     */
    ...
    /**
     * 3D OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X,
     * Z). Recommended for 3D terrain and time-varied animations. The Y
     * coordinate should always be the "different" coordinate in whatever your
     * use case is. If Y is vertical in world coordinates, call
     * noise3_ImproveXZ(x, Y, z). If Z is vertical in world coordinates, call
     * noise3_ImproveXZ(x, Z, y) or use noise3_ImproveXY. For a time varied
     * animation, call noise3_ImproveXZ(x, T, y) or use noise3_ImproveXY.
     */
    ...
    /**
     * 3D OpenSimplex2S/SuperSimplex noise, fallback rotation option Use
     * noise3_ImproveXY or noise3_ImproveXZ instead, wherever appropriate. They
     * have less diagonal bias. This function's best use is as a fallback.
     */
    ...
    /**
     * 4D SuperSimplex noise, with XYZ oriented like noise3_ImproveXY and W for
     * an extra degree of freedom. W repeats eventually. Recommended for
     * time-varied animations which texture a 3D object (W=time) in a space
     * where Z is vertical
     */
    ...
    /**
     * 4D SuperSimplex noise, with XYZ oriented like noise3_ImproveXZ and W for
     * an extra degree of freedom. W repeats eventually. Recommended for
     * time-varied animations which texture a 3D object (W=time) in a space
     * where Y is vertical
     */
    ...
    /**
     * 4D SuperSimplex noise, with XYZ oriented like noise3_Fallback and W for
     * an extra degree of freedom. W repeats eventually. Recommended for
     * time-varied animations which texture a 3D object (W=time) where there
     * isn't a clear distinction between horizontal and vertical
     */
     ...
     * approaches, but it competes performance-wise with optimized 2014
     * OpenSimplex.
     */
    ...
    private static class LatticeVertex4D {
        ...
        public LatticeVertex4D(int xsv, int ysv, int zsv, int wsv) {
            ...
            this.ysvp = ysv * PRIME_Y;
            this.zsvp = zsv * PRIME_Z;
            this.wsvp = wsv * PRIME_W;
